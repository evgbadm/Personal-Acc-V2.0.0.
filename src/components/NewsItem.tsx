...
} from "./plasmic/personal_acc_v_2_0_0/PlasmicNewsItem";
...
// Omit to hide them:
//
// interface NewsItemProps extends Omit<DefaultNewsItemProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function NewsItem_(props: NewsItemProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicNewsItem newItem={{ ref }} {...props} />;
}
