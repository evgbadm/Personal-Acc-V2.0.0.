...
import Label from "../../Label"; // plasmic-import: 3Fl2YIhJ4kw3/component
import TextInput from "../../TextInput"; // plasmic-import: V4hyYX8r6OZY/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: ifPbv4KDt_wa/component
import Description from "../../Description"; // plasmic-import: tnMVrZXo6ngb/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: hWUc4qE7DrgS/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: IlRF-DjGQVdE/icon
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__r2XhH, {
          [sty.freeBoxiconEnd__r2XhHxTc1]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__r2XhHvj7Av]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__r2XhH5Hdnn]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__bkWMm, {
            [sty.freeBoxiconStart__bkWMmvj7Av]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__bkWMm5Hdnn]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__ewTcy)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___7WAw3, {
            [sty.freeBoxiconEnd___7WAw3XTc1]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart___7WAw3Vj7Av]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__g4YEr)}
                role={"img"}
              />
            ),
